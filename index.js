...
document.addEventListener("DOMContentLoaded", function () {
    fetch("nowplaying.json")
        ...
        .then(data => {
            ...
            movieContainer.innerHTML = ""; // Kosongkan sebelum memasukkan data baru
            
            data.movies.forEach(movie => {
                const movieElement = document.createElement("div");
                movieElement.classList.add("movie");
                movieElement.dataset.movie = movie.id;
                movieElement.innerHTML = `
                    <a href="moviedetailsnowplay.html?movie=${movie.id}" class="movie-link">
    ...
    fetch("upcoming.json")
      ...
      .then(data => {
        ...
        data.upcomingMovies.forEach(movie => {
          const movieElement = document.createElement("div");
          movieElement.classList.add("movie");
          movieElement.dataset.movie = movie.title.toLowerCase().replace(/\s+/g, "");

          movieElement.innerHTML = `
            <a href="${movie.detailsPage}" class="movie-link">
